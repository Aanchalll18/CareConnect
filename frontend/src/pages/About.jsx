...
// 						way.
// 					</p>
// 					<b className="text-greytxt">Our Vision</b>
// 					<p>
...
// 					WHY <span className="text-grey-500 font-semibold">CHOOSE US</span>
// 				</p>
// 			</div>
// 			<div className="flex flex-col md:flex-row mb-20">
// 				<div className="border  border-gray px-10 md:px-16 py-8 sm:py-16 flex flex-col gap-5 text-[15px]">
// 					<b>EFFICIENCY:</b>
// 					<p>
